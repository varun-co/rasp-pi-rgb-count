...
yticks = list(range(350,800,50))
print(yticks)
plt.plot(np.array(xaxis),np.array(wavelength),color=average(red,green,blue))
#plt.plot(np.array(xaxis),np.array(red),color='red')
#plt.yticks(yticks)
plt.xlabel('Time in Seconds')
plt.ylim(350,850)
plt.ylabel('Wavelength of light in nm')
plt.title('Wavelength of light')
plt.savefig('Wavelength of Materials')
